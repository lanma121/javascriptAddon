...
(function($){
    ...
    $.fn.magnifier = function(options){
        ...
        return this.each(function(){
            ...
            var obj = $(this);
            //检测是否有images
            if(this.nodeName !=="IMG" && obj.css("backgroundImage")==="none"){alert("not image");
                return obj;
            }
            ...
            function Smallimage(thumbnail) {
                ...
                thumbnail.on("error", function () {
                    if(window.console&&window.console.error)console.error('Problems while loading small image.');
                    throw 'Problems while loading small image.';
                });
                $obj.fetchdata();
                return $obj;
            }
            ...
            function Largeimage(url) {
                ...
                this.node.onerror = function () {
                    if(window.console&&window.console.error)console.error('Problems while loading the big image.');
                    _this.readyOk = false;
